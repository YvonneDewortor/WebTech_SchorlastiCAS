...
<body>
    ...
    <div class="container">
        <h2>Delete Cinema</h2>
        <h1>Remove a Cinema!</h1>

        <div class="tbl-container">
            <div class="centered-div">
                <form autocomplete="off" action="" class="search_form">
                    <input type="hidden" name="cinema_call" id="cinema_call"/>
                    <input type="search" name="cinema_search" id="cinema_search" placeholder="Movie Name">
            ...
            <ul class="responsive-table pagination">
                ...
                <li class="table-row">
                    <input type="hidden" name="cinema_delete_post" id="cinema_delete_post" value="empty"/>
                    <div class="col col-1" id="cinema_id_entry">Null</div>
                    <div class="col col-2" id="cinema_name_entry">Null</div>
                    <div class="col col-3" id=""><button id="delete_cinema"><i class="fas fa-trash"></i></button></div>
                </li>
            </ul>
        </div>
    </div>
